...
import 'package:work_space/screen/exercise_screen.dart';
        ...
        child: Stack(
          children: <Widget>[
            ...
            Container(
              ...
              child: RaisedButton(
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context)=> ExerciseScreen(exercises: widget.exercises,
                  seconds: seconds,
                  ),
                  ),
                  );
